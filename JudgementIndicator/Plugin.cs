...
using JudgementIndicator.Patches;
...
namespace JudgementIndicator
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, "JudgementIndicator", PluginInfo.PLUGIN_VERSION)]
#if TAIKO_MONO
...
#endif
    {
        ...
        private void SetupHarmony()
        {
            ...
            {
                _harmony.PatchAll(typeof(JudgementIndicatorPatch));
